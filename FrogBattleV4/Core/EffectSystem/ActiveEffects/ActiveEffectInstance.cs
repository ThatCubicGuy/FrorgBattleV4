...
public class ActiveEffectInstance(ActiveEffectApplicationContext ctx)
{
    ...
    public uint GetStacks(EffectContext ctx) => Stacks;

    public EffectFlags Props { get; init; } = EffectFlags.None;

    public IReadOnlyList<IModifierComponent>? Modifiers => Definition.Modifiers;
