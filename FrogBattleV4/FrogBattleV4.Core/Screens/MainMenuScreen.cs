...
using FrogBattleV4.Core;
using FrogBattleV4.Core.Effects;
using FrogBattleV4.Core.Inputs;
...
namespace FrogBattleV4.Screens;
...
class MainMenuScreen : MenuScreen
{
    ...
    private void SetLanguageText()
    {
        ...
        Title = "FrogBattleV4"; // TODO uncomment this if you want it to use Resources.MainMenu; instead
    }
    ...
    public override void LoadContent()
    {
        ...
        settingsManager ??= ScreenManager.Game.Services.GetService<SettingsManager<FrogBattleV4Settings>>();
